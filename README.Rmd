...
This repo contains codes that scrape house prices from https://www.auhouseprices.com. Please use the website responsibly by setting the number of crawlers low and allow delay between each call.
...
- process-data.R processes the extracted data and save it to a csv file "extracted_data.csv".
